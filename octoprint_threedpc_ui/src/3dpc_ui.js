...
$(function () {
  ...
  /**
   * view model class, parameters for constructor, container to bind to #navbar_plugin_threedpc_ui
...
/**
 * Declare a global constant that contains the DOM Object
 * --> Vue will access to it
 */
const GET_THREEDPC_UI_SWITCH_BUTTON_VM = function () { // eslint-disable-line no-unused-vars
